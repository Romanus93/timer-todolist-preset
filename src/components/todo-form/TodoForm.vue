  ...
  <section class="todo-flex todo-form-component">
    <ul class="todo-flex todo-info todo-info--bg-image">
      <li class="todo-date">
        <span> {{ date }} </span>
        <button
          class="change-date-button button--pocket-calendar"
          type="button"
          @click="showPocketCalendar(true)"
          v-show="!showingPocketCalendar"
        >
          <i class="far fa-calendar-alt"></i>
        </button>
        <button
          class="check-date-button button--pocket-calendar"
          type="button"
          @click="showPocketCalendar(false)"
          v-show="showingPocketCalendar"
        >
    ...
    <ul class="todo-flex create-edit-buttons-wrap">
      <li>
        <button
          class="create-edit-button button--calendar button--calendar-image"
      ...
      <li>
        <button
          class="home-button button--calendar button--calendar-image"
          @click="goCalendar()"
        >
    ...
    <div class="check-modal todo-flex" v-show="showingWarning">
      <div class="check-modal__text">
        <p>시간을 입력해주세요.</p>
        <button @click="showingWarning = false">
